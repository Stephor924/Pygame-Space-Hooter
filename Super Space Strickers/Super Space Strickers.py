...
# loading sprites
background = pygame.transform.scale(pygame.image.load('space_background.gif'),
                                    (WIDTH, HEIGHT))  # loads and scales image to window size
player = pygame.transform.scale(pygame.image.load('spaceship.png'), (player_width, player_width))
...
laser = pygame.transform.scale(pygame.image.load('bullet.png'), (laser_width, laser_height))

alien_1 = pygame.transform.scale(pygame.image.load('alien.png'), (alien_width, alien_width))
...
pygame.init()
my_font = pygame.font.SysFont("Space Crusaders Italic.ttf", 64)  # this needs to be after pygame.init()
game_over_font = pygame.font.SysFont("Space Crusaders Italic.ttf", 120, bold=True)  # game over font
...
def win():
    ...
    if boss_death_count + 1 >= 150:
        ...
        pygame.mixer.Channel(7).play(pygame.mixer.Sound('Mega Man X (SNES) - Stage Clear Theme .mp3'))
        while win:
            screen.fill(WHITE)
            ...
            screen.blit(pygame.transform.scale(pygame.image.load('spaceship.png'), (300, 300)),
...
def game_over():
    ...
    while game_over:
        ...
        screen.blit(pygame.transform.scale(pygame.image.load('alien_boss.png'), (600, 300)),
        ...
        if keys[pygame.K_r]:
            game_over = False
            song = pygame.mixer.music.load('tomp3.cc - StarTropics Music  Cave.mp3')
